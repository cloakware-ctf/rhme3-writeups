...
test_one_roundtrip(instigat.tobytes(), single_clk_pulse, unexpected_output_action, serial_handler)
test_one_roundtrip(blanksss.tobytes(), single_clk_pulse, unexpected_output_action, serial_handler)
